    ...
    <div id="Payfast" class="tab_content">
        ...
        <fieldset>
            ...
            <div class="payfast_section">
                ...
                <span>
						<input type="hidden" name="module[default]" id="default" class="toggle"
            ...
            <div class="payfast_section">
                ...
                <span>
						<input class="payfast_input" name="module[desc]" id="desc" class="textbox" type="text"
                               value="{$MODULE.desc}" placeholder="Reference to represent this gateway"/>
					</span>
            </div>
            ...
            <div class="payfast_section">
                ...
                <span>
						<input class="payfast_input" name="module[merchant_id]" id="merchant_id" class="textbox"
                               type="text" value="{$MODULE.merchant_id}" placeholder="merchant-id"/>
					</span>
            </div>
            <div class="payfast_section">
                <label class="payfast_label" for="merchant_key">{$LANG.payfast.merchant_key}</label>
                <span>
						<input class="payfast_input" name="module[merchant_key]" id="merchant_key" class="textbox"
                               type="text" value="{$MODULE.merchant_key}" placeholder="merchant-key"/>
					</span>
            </div>
            <div class="payfast_section">
                <label class="payfast_label" for="passphrase">{$LANG.payfast.passphrase}</label>
                <span>
						<input class="payfast_input" name="module[passphrase]" id="passphrase" class="textbox"
                               type="text" value="{$MODULE.passphrase}" placeholder="Passphrase"/>
					</span>
            </div>
            <div class="payfast_section">
                <label class="payfast_label" for="mode">{$LANG.payfast.mode}</label>
                <span>
						<input name="module[testMode]" id="mode" class="toggle" type="hidden" class="toggle"
            ...
            <div class="payfast_section">
                ...
                <span>
						<input type="hidden" name="module[debug_log]" id="debug_log" class="toggle"
                               value="{$MODULE.debug_log}"/>
					</span>
            </div>
            <div class="payfast_section">
                <label class="payfast_label" for="email">{$LANG.payfast.debug_email}</label>
                <span>
						<input class="payfast_input" placeholder="Debug Email" name="module[debug_email]" id="email"
                               class="textbox" type="text" value="{$MODULE.debug_email}"/>
					</span>
            </div>
    </div>
    {$MODULE_ZONES}
